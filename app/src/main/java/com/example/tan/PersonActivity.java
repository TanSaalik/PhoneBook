...
public class PersonActivity extends AppCompatActivity {
    ...
    private EditText txtZip, txtFirstName, txtLastName, txtAddress, txtPhone, txtEmail,
            txtDate, txtTitle, txtText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (obj != null) {
            ...
            txtDate.setText(String.format("%02d-%02d-%d", cal.get(Calendar.DAY_OF_MONTH),
        ...
        disable(txtDate);
        //disable(txtZip);
        // "You can not change the zip code. It’s probably a little too
        // restrictive. Solve this problem when the field of the zip code always must
        // contain a legal zip code."
    }

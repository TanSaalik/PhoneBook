...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        menu.add(Menu.NONE, MENU_SHOW, Menu.NONE, getString(R.string.showContact));
        menu.add(Menu.NONE, MENU_CREATE, Menu.NONE, getString(R.string.createContact));
    }
    ...
    private void showPeople(Zipcode zipcode) {
        ...
        if (people.getPeople().size() == 0){
            Toast.makeText(this, getString(R.string.notFound), Toast.LENGTH_LONG).show();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(Menu.NONE, MENU_SEARCH, Menu.NONE, getString(R.string.searchContact));
